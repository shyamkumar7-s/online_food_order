...
class Menu extends CI_Controller {
    ...
    public function index($username){
        ...
        $rid=$store['r_id'];
        $dishesh = $this->Menu_model->getDishesh($rid);
        $data['dishesh'] = $dishesh;
        $this->load->view('vendor/partials/header');
        $this->load->view('vendor/menu/list', $data);
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    redirect(base_url(). 'vendor/menu/index/'.$username);
                    ...
                    $data['stores']= $store;
                    $this->load->view('vendor/partials/header');
                    $this->load->view('vendor/menu/add_menu', $data);
                    $this->load->view('vendor/partials/footer');
                }
            ...
            $this->load->view('vendor/partials/header');
            $this->load->view('vendor/menu/add_menu', $store_data);
            $this->load->view('vendor/partials/footer');
        }
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    redirect(base_url(). 'vendor/menu/index');
                    ...
                    $data['stores'] = $store;
                    $this->load->view('vendor/partials/header');
                    $this->load->view('vendor/menu/edit', $data);
                    $this->load->view('vendor/partials/footer');
                }
