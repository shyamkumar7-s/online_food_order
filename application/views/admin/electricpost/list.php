        ...
        <div class="table-responsive-sm">
            <table class="table table-bordered table-striped table-hover table-responsive">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        <td><?php echo $user['post_id']; ?></td>
                        <td><?php echo $user['electric_post']; ?></td>
                        <td><?php echo $user['address']; ?></td>
                        <td><?php echo $user['pincode']; ?></td>

                        <td>
                            <a href="<?php echo base_url().'admin/electricpost/edit/'.$user['post_id'];?>"
                                class="btn btn-info mb-1"><i
                                    class="fas fa-edit mr-1"></i>Edit</a>
                            <a href="javascript:void(0);" onclick="deleteUser(<?php echo $user['post_id']; ?>)"
