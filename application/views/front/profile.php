                ...
                <div class="py-2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                class="bg-light form-control <?php echo (form_error('mode') != "") ? 'is-invalid' : '';?>"
                                name="mode" value="<?php echo set_value('mode', $user['mode'])?>">
                            <?php echo form_error('mode'); ?>
                        </div>
                        <div class="col-md-6">
                            <label for="electric_pole_no">Electric Pole No</label>
                            <input type="text"
                                class="bg-light form-control <?php echo (form_error('electric_pole_no') != "") ? 'is-invalid' : '';?>"
                                name="electric_pole_no" value="<?php echo set_value('electric_pole_no', $user['electric_pole_no'])?>">
