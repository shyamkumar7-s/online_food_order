...
<body>
    <div class="wrapper container">
        ...
        <form action="<?php echo base_url().'singup/create_user'; ?>" method="POST" name="myForm" id="myForm"
            ...
            <div class="row">
                ...
                <?php echo (form_error('mode') != "") ? 'is-invalid' : '';?> 
                ...
                <?php echo (form_error('electric_pole_no') != "") ? 'is-invalid' : '';?>" name="electric_pole_no" placeholder="electric_pole_no"
                            id="electric_pole_no" value="<?php echo set_value('electric_pole_no')?>">
    ...
    const electric_pole_no = document.getElementById('electric_pole_no');
    ...
    function setSuccessMsg(ele) {
        ...
        href="<?php echo base_url().'singup/create_user'?>
        console.log('home2');
    }
console.log('home');
    </script>
