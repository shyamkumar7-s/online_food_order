<div class="conatiner">
    <form action="<?php echo base_url().'vendor/store/create_restaurant';?>" method="POST"
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="control-label">erer</label>
                    <input type="text" name="u_id" id="u_id" class="form-control
                    "value='<?php $user = $this->session->userdata('user'); 
                  echo $user ;?>'>
                        <span></span>
                </div>
        ...
        <div class="form-group">
            ...
            <select name="c_name" id="c_name" class="form-control <?php echo (form_error('c_name') != "") ? 'is-invalid' : '';?>">
                ...
                <?php  $cat = $this->session->userdata('cat'); 
                  echo $cat ;die;
                if (!empty($cats)) { 
                    foreach($cats as $cat) {
                        ?>
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo base_url().'vendor/store/index'?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
<script>
