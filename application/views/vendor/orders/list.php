            ...
            <table class="table table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url().'vendor/orders/processOrder/'.$order['o_id'].'/'.$admin;?>"
                                class="btn btn-info mb-1">                               <i class="fas fa-arrow-alt-circle-right"></i> Process</a>
                            <a href="<?php echo base_url().'vendor/orders/deleteOrder/'.$order['o_id'].'/'.$admin;?>"
...
function deleteOrder(id) {
    if (confirm("Are you sure you want to delete orders?")) {
        window.location.href = '<?php echo base_url().'vendor/orders/deleteOrder/';?>' + id;
    }
}
